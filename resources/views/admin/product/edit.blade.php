            ...
            <div class="body">
                ...
                <form method="POST" action="{{ route('admin.product.update', ['id' => $viewData['product']->getId()]) }}"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3 row">
                                <label class=" col-md-6 col-sm-12 col-form-label"> Name: </label>
                        ...
                        <div class="col">
                            <div class="mb-3 row">
                                <label class="col-md-6 col-sm-12 col-form-label"> Price: </label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    <label class="col-md-6 col-sm-12 col-form-label"> Image: </label>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
